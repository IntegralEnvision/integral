...
# LOAD DATA --------------------------------------------------------------------
## PFAS data ----
# QA: 5061 | files are brought in with logical names
...
## Oakdale PFAS data -----
# QA: 4458 | files are brought in with logical names
...
## VAP data ----
# QA: 4991 | files are brought in with logical names
...
# QA: 7928 | files are brought in with logical names
