...
# LOAD DATA --------------------------------------------------------------------
## PFAS data ----
# QA: 7280 | files are brought in with logical names
...
## Oakdale PFAS data -----
# QA: 5491 | files are brought in with logical names
...
## VAP data ----
# QA: 2227 | files are brought in with logical
...
# QA: 9474 | files are brought in with logical
...
# QA: 1628 | files are brought in with logical
